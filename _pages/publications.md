...
* Yuan, H.†, Hong, C.†, ... & Liu, N. (2024). Domain Knowledge-Based Template Improves Post Hoc Explanations in Pneumothorax Classification. *arXiv*. ([Paper](http://han-yuan-med.github.io/files/.pdf), [Code](https://github.com/Han-Yuan-Med/template-explanation))
...
* Kang, L., …, Yuan, H. & Zhu, C. (2024). Approximate Policy Iteration with Deep Minimax Average Bellman Error Minimization. *IEEE Transactions on Neural Networks and Learning Systems*. ([Paper](http://han-yuan-med.github.io/files/.pdf))
